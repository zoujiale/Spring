...
//'use strict';
    ...
    window.CommonTable = function (tableId, ajaxSource, searchDiv) {
        ...
        // 初始化表格
        this.initTable(tableId, ajaxSource, searchDiv);
     ...
     * 初始化表格
     */
    CommonTable.prototype.initTable = function (tableId, ajaxSource, searchDiv) {
        ...
        this.table = $('#' + tableId).DataTable($.extend({
            ...
            "language": { // 中文支持
                "sUrl": basePath + "/adminlte/common/json/zh_CN.json"
            },
            "displayLength": that.data.pageInfo.pageSize,// 每页记录条数，默认为10
            "serverSide": true,
            "ajaxDataProp": "data",
            "ajaxSource": basePath + "/role/loadRole",
