...
<html>
	...
	<body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <small>Blank example to the fixed layout</small>
								...
								<div class="box-body">
									<div class="box box-widget widget-user">
										...
										<div class="widget-user-image">
											<img class="img-circle" src="${pgc }/index/dist/img/user1-128x128.jpg" alt="User Avatar">
										</div>
                ...
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-info	">8 位成员</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
  ...
  <input type="radio" name="MALE" id="inlineRadio1" value="MALE" checked="checked"> 男
</label>
															<label class="radio-inline">
  <input type="radio" name="MALE" id="inlineRadio1" value="WOMAN"> 女
</label>
														</div>
													</div>
												</div>
