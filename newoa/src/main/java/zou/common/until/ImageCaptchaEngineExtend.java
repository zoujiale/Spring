...
public class ImageCaptchaEngineExtend extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		...
		RandomRangeColorGenerator colors = new RandomRangeColorGenerator(new int[] { 0, 150 }, new int[] { 0, 150 },
				new int[] { 0, 150 });
		...
		// 设置字符以及干扰线
		/*
		 * RandomRangeColorGenerator lineColors = new RandomRangeColorGenerator( new
		 * int[] { 150, 255 }, new int[] { 150, 255 }, new int[] { 150, 255 });
		 */

		/*
		 * TextPaster randomPaster = new DecoratedRandomTextPaster(new Integer(4), new
		 * Integer(4), colors, true, new TextDecorator[] { new LineTextDecorator(new
		 * Integer(1), lineColors) });
		 */
