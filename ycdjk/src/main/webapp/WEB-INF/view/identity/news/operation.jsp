	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					新闻编辑 <small>it all starts here</small>
				</h1>
				<ol class="breadcrumb">
									...
									<table class="table no-margin">
										...
										<tbody>
											<c:forEach items="${article.recordList }" var="a">
												...
												<tr>
													<td><a href="pages/examples/invoice.html">${a.title}</a></td>
													<td>${a.source}</td>
													<td><span class="label label-success">${a.createDate }</span></td>
													<td>
													...
													<td><a class="btn btn-primary btn-xs">编辑</a> <a
														...
														href="${pgc }/identity/news/delete/${a.id}">delete</a></td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="boxRoleForm" enctype="multipart/form-data" method="post"  action="${pgc }/identity/news">
							<div class="form-group">
								<label for="recipient-name" class="control-label">上传图片:</label>
								<input type="file" id="imageName" name="file"> 
					</div>
					<div class="form-group">
						<label for="recipient-name" class="control-label">新闻标题</label> <input
							type="text" class="form-control" name="title" id="title"
							placeholder="请输入新闻标题">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="control-label">简单描述:</label> <input
							type="text" class="form-control" id="simpleDescripe"
							name="simpleDescripe" placeholder="请输入新闻的简单描述 大概 10-30字">
					</div>

					<div class="form-group">
						<label for="recipient-name" class="control-label">新闻来源:</label>
						<div class="radio">

							<label> <input type="radio" name="source"
								id="optionsRadios1" value="迎春大健康" checked> 迎春大健康 <input
								type="hidden" name="imageName" id="hiddle_name">
							</label> <label> <input type="radio" name="source"
								id="other_sourse" value="其他"> 其他 <input type="text"
								id="chage">
					...
					<div class="form-group">
						<label for="recipient-name" class="control-label">内容正文:</label>
		...
		$(document).ready(
				function() {
					...
					$("#save_article").click(function() {
						...
						$("#hiddle_name").val(filename);
						var from = $("#boxRoleForm").serialize();
						$("#boxRoleForm").submit();
					});
